...
if(!isset($user_id)){
 ...
 // Redirect if payment method is 'debit card'
...
if(isset($_POST['order'])){
   ...
   // $debitcard = '. '. $_POST['flat'] .' '. $_POST['street'] .' '. $_POST['city'] .' '. $_POST['state'] .' '. $_POST['country'] .' - '. $_POST['pin_code'];
   $method = $_POST['method'];
...
<?php 
if(isset($_POST['method']) && $_POST['method'] == 'debit card') {
